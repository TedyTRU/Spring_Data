...
public class WizardDeposits extends BaseEntity {
    ...
    private Boolean idDepositExpired;
    ...
    public Boolean getIdDepositExpired() {
        return idDepositExpired;
    }

    public void setIdDepositExpired(Boolean idDepositExpired) {
        this.idDepositExpired = idDepositExpired;
    }
}
