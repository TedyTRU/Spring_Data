...
public class BookServiceImpl implements BookService {
    ...
    public List<Book> findAllBooksAfterYear(int year) {
        return bookRepository
                .findAllBooksByReleaseDateAfter(LocalDate.of(year, 12, 31));
    }
    ...
    @Override
    public List<String> findAllBooksByAuthorName(String firstName, String lastName) {
    ...
    private Book createBookFromData(String[] data) {
        ...
        LocalDate releaseDate = LocalDate
                .parse(data[1], DateTimeFormatter.ofPattern("d/M/yyyy"));
